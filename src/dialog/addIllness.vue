            ...
            <v-card-text>
              <v-row>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="İsim*" v-model="illness.name" required outlined ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-select :items="branch" :key="illness.branch" item-value="id" label="Branş" v-model="illness.branch" item-text="name" outlined ></v-select>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-switch label="İlaç kullanılarak mı tedavi ediliyor?" v-model="illness.is_medicine" outlined ></v-switch>
                </v-col>
              </v-row>
