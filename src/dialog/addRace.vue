      ...
      <v-container>
        <v-dialog v-model="dialog" max-width="800px">
          ...
          <v-card style="background-color: #F2E3DB;">
            <v-card-title>
              <span class="text-h5">Irk Bilgileri</span>
            </v-card-title>
            <v-card-text>
              <v-row>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="İsim*" v-model="race.name" required outlined ></v-text-field>
                </v-col>
              </v-row>
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" text @click.prevent="addRace">
                Kaydet
              </v-btn>
            </v-card-actions>
          </v-card>
