                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    ...
                                    <!-- HASTALIK -->
                                    <div v-for="illness in illness" :key="illness.name">
                                        <v-col cols="12" sm="6" md="4">
                                            <v-select v-bind:items="illness.name" label="Hastalık"
                                                v-model="pet.illness">
                                            </v-select>
                                        </v-col>
                                    </div>
                                    <div v-for="gadgettype in gadgettype" :key="gadgettype.name">
                                        <v-col cols="12" sm="6" md="4">
                                            <v-autocomplete :items=gadgettype.dress label="Kıyafetler"
                                                v-model="pet.gadgettype" multiple></v-autocomplete>
                                        </v-col>
                                    </div>
                                </v-row>
                            </v-container>
